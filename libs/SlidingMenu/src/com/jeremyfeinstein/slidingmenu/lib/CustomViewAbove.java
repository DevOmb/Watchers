...
public class CustomViewAbove extends ViewGroup {
    ...
    private boolean mCloseOutside = true;
        ...
        switch (action & MotionEventCompat.ACTION_MASK) {
            ...
            case MotionEvent.ACTION_UP:
                if (mEnabled && mIsBeingDragged) {
                    ...
                    mActivePointerId = INVALID_POINTER;
                    endDrag();
                } else if (mCloseOutside && isMenuOpen() && mViewBehind.menuTouchInQuickReturn(mContent, mCurItem, ev.getX() + mScrollX)) {
                    // close the menu
                    setCurrentItem(1);
                    endDrag();
                }
